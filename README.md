...
Specifically __"standalone" computed properties should be allowed__ to also enable dynamic dotstructuring:
```js
const p = 'prop1';
obj.{[p]};
```
...
Bob Myers' [proposal](https://github.com/rtm/js-pick-notation) points out the following:
